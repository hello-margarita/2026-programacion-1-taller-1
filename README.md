...
*   **Composition:** Modeling complex relationships (e.g., a Car "has an" Engine).
*   **Exception Handling:** Implementing custom error logic (`ExcesoVelocidadException`).

### 📁 Project Structure
The repository is organized into 10 independent scripts, each addressing a specific OOP concept from the workshop guidelines.

---
*Developed by [Margarita Arango Vélez](https://hellomargarita.io) - Systems Engineering Student*
